...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SMC_OrganizationE.aspx.cs" Inherits="IIS.Product_4858.SMC_OrganizationE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlCountEmployeeLabel" runat="server" Text="Количество работников" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlCountEmployee" Type="Numeric" runat="server">
