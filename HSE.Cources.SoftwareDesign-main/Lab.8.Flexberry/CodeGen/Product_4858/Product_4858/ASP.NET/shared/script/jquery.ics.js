...
; (function ($, window, document, undefined) {
    ...
    // Не используем window.onload = function() {} т.к. если в прикладном коде перезапишут window.onload, функция не вызовется.
        ...
        dialog: {
            ...
            modal: function (options) {
                ...
                var $dialog = modalContent.dialog(options, {
                    ...
                    resizeStop: function () {
                        this.style.width = this.offsetParent.clientWidth.toString() + 'px';
                        this.style.height = (this.offsetParent.clientHeight - 50).toString() + 'px';
                    },
