...
namespace Lab._5.LINQ.UI.Controls
{
    /// <summary>
    ...
    public class TextField : TextBox
    {
        ...
        /// </summary>
        private readonly Func<string, bool> _textValidationCallback;
        ...
        static TextField() {
            ...
            PlaceholderForegroundProperty = DependencyProperty.Register
                (
            ...
            IsPlaceholderShowingProperty = DependencyProperty.Register
                (
        ...
        public TextField
        (
            Func<string, bool> textValidationCallback
        ) {
            _textValidationCallback = textValidationCallback;
        }
        ...
        ///         <cref>true</cref>
        ///     </see>
        ///     и переданный при инициализации экземпляра делегат вернет
        ///     <see>
        ///         <cref>true</cref>
        ///     </see>
        ///     ,
        ///     то заполнитель отображен не будет. Если передать
        ///     <see>
        ///         <cref>false</cref>
        ///     </see>
        ///     , то метод для проверки действительности
        ///     текста вызываться не будет.
        /// </param>
        public void ShowPlaceholder
        (
            bool askTextValidation
        ) {
            if (askTextValidation &&
                _textValidationCallback
                    (
                     Text
                    ))
                return;
            ...
            _originalForegroundBrush = Foreground;
        ...
        public void HidePlaceholder() {
            ...
            Foreground = _originalForegroundBrush;
        }
