...
namespace SmartHouse_Control.Output
{
    ...
    ///     Class for output
    /// </summary>
    internal class excel_using : IExcel
    {
        #region Initialize
        ...
        private void dlg_FileSaveAs(object sender, CancelEventArgs e) {
            ...
            try {
                ...
                workbook.SaveAs(fInfo.FullName);
                workbook.Close();
                objExcel.Quit();
            }
            catch (Exception __e) {
        ...
        public void output_type_one(string room_name, DataTable dt) {
        ...
        private void dlg_Parser(object sender, CancelEventArgs e) {
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable input_file(DataTable dt) {
            first_data = dt;
            inp_data = new DataTable();
            open_file();
            try {
